 ...
 */
public abstract class AbstractThiefProblem {
    ...
    public AbstractThiefProblem(AbstractThiefProblem problem) {
    ...
    public TTPSolution evaluate(List<Integer> pi, List<Boolean> z, boolean copy) {
        ...
        switch (getNumberOfObjectives()) {
            case 1:
                s.objectives = Arrays.asList(-singleObjective);
                break;
            case 2:
