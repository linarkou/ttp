...
public class Verify {
    ...
    public static void main(String[] args)  throws IOException {
        ...
        final String TEAM = "Linarkou";

        List<String> instances = Arrays.asList("a280_n279");
//                , "a280_n1395", "a280_n2790",
//        "fnl4461_n4460", "fnl4461_n22300", "fnl4461_n44600", "pla33810_n33809", "pla33810_n169045", "pla33810_n338090");
        ...
        for (String instance : instances) {
            ...
            try (BufferedReader br = new BufferedReader(new FileReader(pathToX.toFile()))) {
                ...
                while (true) {
                    ...
                    if (pi.size() != problem.numOfCities) {
                        ...
                        System.out.println(String.format("TTPSolution %s", counter));
                    ...
                    TTPSolution TTPSolution = problem.evaluate(pi, z);
                    ...
                    if (Math.abs(time - TTPSolution.time) > precision || Math.abs(profit - TTPSolution.profit) > precision) {
                        System.out.println("ERROR");
                        System.out.println(String.format("TTPSolution %s", counter));
                        System.out.println(String.format("Reported time is %s. Evaluated %s.", time, TTPSolution.time));
                        System.out.println(String.format("Reported profit is %s. Evaluated %s.", profit, TTPSolution.profit));
            ...
            if (counter > numberOfSolutions) {
                System.out.println(String.format("WARNING: Finally the ru.linarkou.competition allows only %s solutions to be submitted. " +
